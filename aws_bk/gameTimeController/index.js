...
exports.generatedTimeEveryAfterEveryOneMinAWS = (io) => {
...
exports.jobRunByCroneAWS = async () => {
  ...
  async function callAPI() {
    try {
      ...
      await queryDb("SELECT @result_msg;", [])
        .then((newresult) => {
          resultToBeSend = newresult?.[0]?.["@result_msg"];
        })
        .catch((e) => {
          console.log(e);
        });
...
// exports.jobRunByCroneAWSForWingoGame = async () => {
//   console.log("functoin called");
